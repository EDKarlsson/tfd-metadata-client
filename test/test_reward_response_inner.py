    ...
    def make_instance(self, include_optional) -> RewardResponseInner:
        ...
        if include_optional:
            return RewardResponseInner(
                ...
                map_name = '',
                battle_zone = [
                    tfd_metadata_client.models.reward_response_inner_battle_zone_inner.RewardResponse_inner_battle_zone_inner(
                        battle_zone_id = '', 
                        battle_zone_name = '', 
                        reward = [
                            tfd_metadata_client.models.reward_response_inner_battle_zone_inner_reward_inner.RewardResponse_inner_battle_zone_inner_reward_inner(
                                rotation = 1.337, 
                                reward_type = '', 
