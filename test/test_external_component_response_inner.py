    ...
    def make_instance(self, include_optional) -> ExternalComponentResponseInner:
        ...
        if include_optional:
            return ExternalComponentResponseInner(
                ...
                available_core_slot = '',
                base_stat = [
                    tfd_metadata_client.models.external_component_response_inner_base_stat_inner.ExternalComponentResponse_inner_base_stat_inner(
                        level = 1.337, 
                        stat_id = '', 
                        stat_value = 1.337, )
                    ],
                set_option_detail = [
                    tfd_metadata_client.models.external_component_response_inner_set_option_detail_inner.ExternalComponentResponse_inner_set_option_detail_inner(
                        set_option = '', 
                        set_count = 1.337, 
                        set_option_effect = '', )
                    ]
